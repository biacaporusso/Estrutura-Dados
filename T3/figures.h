...
void setEnergia(Figura Fig, double e);  // seta o valor da energia da figura
void perdaEnergia(Figura Fig, double e);    // seta o valor da energia após sofrer uma perda "e"
double getEnergia(Figura Fig);  // retorna a energia da figura
double energiaArremesso(double wRede, double hRede, double d);  // retorna a energia após um arremesso de rede
double getDinheiro(Figura Fig); // retorna a quantia em dinheiro da figura
void setDinheiro(Figura Fig, double din);   // seta a quantidade de dinheiro da figura
